...
async function main() {
  ...
  const bloques = [
    {
      num: 1,
      bogota: { nombre: 'Carulla Bogotá Descuentos B1', img: '/uploads/carulla_bogota_b1.png', txt: '¡30% de descuento en vinos hoy en Carulla Bogotá!' },
    ...
    {
      num: 2,
      bogota: { nombre: 'Carulla Bogotá Descuentos B2', img: '/uploads/carulla_bogota_b2.png', txt: '¡2x1 en toda la categoría de quesos madurados en Carulla Bogotá!' },
    ...
    {
      num: 3,
      bogota: { nombre: 'Carulla Bogotá Descuentos B3', img: '/uploads/carulla_bogota_b3.png', txt: '¡Frescura garantizada! 40% de descuento en frutas y verduras Carulla BOG!' },
    ...
    {
      num: 4,
      bogota: { nombre: 'Carulla Bogotá Descuentos B4', img: '/uploads/carulla_bogota_b4.png', txt: '¡Super jueves! 15% de descuento adicional con tarjeta Carulla BOG!' },
